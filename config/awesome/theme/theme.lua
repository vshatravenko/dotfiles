...
local themes_path = "/home/d33p/.config/awesome/theme/"

-- {{{ Main
local theme = {}
theme.wallpaper = themes_path .. "images/wallpaper.jpg"
-- }}}
...
-- {{{ Icons
theme.widget_cpu = themes_path .. "images/cpu-icon.png"
-- }}}
