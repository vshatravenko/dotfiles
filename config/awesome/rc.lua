...
local tag_history_file = '/home/d33p/.local/share/awesome/tag_history'
...
beautiful.init('/home/d33p/.config/awesome/theme/theme.lua')
...
awful.key({ modkey, 'Control' }, 's', function ()
  awful.util.spawn('xsnap -file /home/d33p/misc/media/pictures/screenshots/screenshot-' .. os.time() .. '.png')
end),
...
awful.rules.rules = {
  ...
  {
    rule = { instance = 'slack' },
    properties = { screen = 2, tag = '3-[TERM]' }
  },
  {
